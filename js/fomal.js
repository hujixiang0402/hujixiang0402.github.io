...
function tonav() {
  ...
  document.getElementById("page-name").innerText = document.title.split(" | 仙丝暮成雪的Blog")[0];
}
...
$.ajax({
  ...
  data: {
    key: 'KI6BZ-XVZ3Q-PMX5V-4CRUY-U2PKS-6KFZ4',  // 这里要写你的KEY!!!
    output: 'jsonp',
  },
  dataType: 'jsonp',
...
function showWelcome() {
  ...
  let dist = getDistance(104.0727450000, 30.5789940000, ipLoacation.result.location.lng, ipLoacation.result.location.lat); //这里换成自己的经纬度
...
function getWeibo() {
  fetch('https://weibo-top-api-nine.vercel.app/api').then(data => data.json()).then(data => {  // 这里要写上你的API!!!
...
function createtime2() {
  ...
  setTimeout(
    console.warn.bind(
      console,
      "%c ⚡ Powered by 仙丝暮成雪🥝 %c 你正在访问仙丝暮成雪🥝の小家",
...
function share_() {
  ...
  try {
    ...
    var subTitle = title.endsWith("| 仙丝暮成雪🥝") ? title.substring(0, title.length - 14) : title;
    navigator.clipboard.writeText('仙丝暮成雪🥝的站内分享\n标题：' + subTitle + '\n链接：' + url + '\n欢迎来访！🍭🍭🍭');
    new Vue({
      data: function () {
        this.$notify({
          title: "成功复制分享信息🎉",
...
function createtime() {
  // 网站诞生时间
  var grt = new Date("05/16/2023 00:00:00");
  ...
  var currentTimeHtml = "";
  currentTimeHtml = `<div style="font-size:13px;font-weight:bold">本站已运行 ${dnum} 天 ${hnum} 小时 ${mnum} 分 ${snum} 秒</div>`;
  ...
  var loop = function () {
    ...
    if (now > 1000 + lastTime) {
      ...
      if (fps <= 5) {
        ...
        var kd = `<span style="color:#9338e6">不太2023🙄</span>`
      } else if (fps <= 45) {
...
if (localStorage.getItem("blogbg") != undefined) {
  ...
  document.getElementById("defineBg").innerText = `:root{
    --default-bg: url(https://lskypro.acozycotage.net/仙丝暮成雪/img/dm14.webp);
    --darkmode-bg:url(https://lskypro.acozycotage.net/仙丝暮成雪/img/yuanshen1.webp);
    --mobileday-bg: url(https://lskypro.acozycotage.net/仙丝暮成雪/img/snow.webp);
    --mobilenight-bg: url(https://lskypro.acozycotage.net/仙丝暮成雪/img/mb8.webp);
  }`;
}
// 切换背景主函数
function changeBg(s) {
...
<details class="folding-tag" cyan><summary> 查看二次元背景 </summary>
              <div class='content'>
              <div class="bgbox"><a href="javascript:;" rel="noopener external nofollow" style="background-image:url(https://lskypro.acozycotage.net/仙丝暮成雪/img/home_bg.webp)" class="imgbox" onclick="changeBg('url(https://lskypro.acozycotage.net/仙丝暮成雪/img/home_bg.webp)')"></a></div>
              </div>
            </details>
...
<details class="folding-tag" cyan><summary> 查看风景背景 </summary>
              <div class='content'>
              <div class="bgbox"><a href="javascript:;" rel="noopener external nofollow" style="background-image:url(https://lskypro.acozycotage.net/仙丝暮成雪/img/fj1.webp)" class="imgbox" onclick="changeBg('url(https://lskypro.acozycotage.net/仙丝暮成雪/img/fj1.webp)')"></a></div>
              </div>
            </details>
...
<details class="folding-tag" cyan><summary> 查看萌宠背景 </summary>
              <div class='content'>
              <div class="bgbox"><a href="javascript:;" rel="noopener external nofollow" style="background-image:url(https://lskypro.acozycotage.net/仙丝暮成雪/img/mc1.webp)" class="imgbox" onclick="changeBg('url(https://lskypro.acozycotage.net/仙丝暮成雪/img/mc1.webp)')"></a></div>
              </div>
            </details>
...
<details class="folding-tag" cyan><summary> 查看适配手机的背景 </summary>
              <div class='content'>
              <div class="bgbox"><a href="javascript:;" rel="noopener external nofollow" style="background-image:url(https://lskypro.acozycotage.net/仙丝暮成雪/img/mb4.webp)" class="pimgbox" onclick="changeBg('url(https://lskypro.acozycotage.net/仙丝暮成雪/img/mb4.webp)')"></a></div>
              </div>
            </details>
