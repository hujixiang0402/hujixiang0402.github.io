...
function dark() {
    ...
    var e, t, n, o, a = .05, s = document.getElementById("universe"), c = !0, r = "226,225,224", i = [];
    function l() {
        e = window.innerWidth,
    ...
    function b() {
        ...
        this.draw = function() {
            ...
            this.giant)
                ...
                for (var e = 0; e < 30; e++)
                    o.fillStyle = "rgba(" + r + "," + (this.opacity - this.opacity / 20 * e) + ")",
    ...
    let a = new MutationObserver((a=>{
        for (let s = 0; s < a.length; s++) {
            let c = a[s].addedNodes
              , r = "";
            2 == c.length && "OwO-body" == c[1].className && (r = c[1],
            document.body.clientWidth <= 768 && r.addEventListener("contextmenu", (e=>e.preventDefault())),
            r.onmouseover = a=>{
...
navigator.userAgent.match(/(phone|pad|pod|iPhone|iPod|ios|iPad|Android|Mobile|BlackBerry|IEMobile|MQQBrowser|JUC|Fennec|wOSBrowser|BrowserNG|WebOS|Symbian|Windows Phone)/i) || window && (()=>{
    let e = 50
      ...
      , s = .7
      , c = .5;
    const r = window.requestAnimationFrame || window.mozRequestAnimationFrame || window.webkitRequestAnimationFrame || window.msRequestAnimationFrame || function(e) {
...
function solar2lunar(e, t, n) {
    ...
    t = s.getMonth() + 1,
    n = s.getDate();
    var r = (Date.UTC(s.getFullYear(), s.getMonth(), s.getDate()) - Date.UTC(1900, 0, 31)) / 864e5;
    for (o = 1900; o < 2101 && r > 0; o++)
        r -= c = lYearDays(o);
    r < 0 && (r += c,
    o--);
    var i = new Date
      , l = !1;
    i.getFullYear() === e && i.getMonth() + 1 === t && i.getDate() === n && (l = !0);
    var d = s.getDay()
      , b = nStr1[d];
    0 === d && (d = 7);
    var u = o;
    ...
    for (o = 1; o < 13 && r > 0; o++)
        a > 0 && o === a + 1 && !1 === m ? (--o,
        m = !0,
        c = leapDays(u)) : c = monthDays(u, o),
        !0 === m && o === a + 1 && (m = !1),
        r -= c;
    0 === r && a > 0 && o === a + 1 && (m ? m = !1 : (m = !0,
    --o)),
    r < 0 && (r += c,
    --o);
    var g = o
...
var calendarFormatter = {
    ...
    lunar2solar: function(e, t, n, o) {
        ...
        e < 1900 || e > 2100 || n > s)
            return -1;
        for (var c = 0, r = 1900; r < e; r++)
            c += lYearDays(r);
        var i = 0
          , l = !1;
        for (r = 1; r < t; r++)
            i = leapMonth(e),
            l || i <= r && i > 0 && (c += leapDays(e),
            l = !0),
            c += monthDays(e, r);
        o && (c += a);
        var d = Date.UTC(1900, 1, 30, 0, 0, 0)
          , b = new Date(864e5 * (c + n - 31) + d);
        return solar2lunar(b.getUTCFullYear(), b.getUTCMonth() + 1, b.getUTCDate())
    }
}
  , d = new Date;
m = d.getMonth() + 1,
...
function createtime() {
    ...
    let u = "";
    u = r < 18 && r >= 9 ? `<img class='boardsign' src='https://sourcebucket.s3.bitiful.net/badge/F小屋-科研摸鱼中.svg' title='什么时候能够实现财富自由呀~'><br> <div style="font-size:13px;font-weight:bold">本站居然运行了 ${s} 天 ${r} 小时 ${l} 分 ${b} 秒 <i id="heartbeat" class='fas fa-heartbeat'></i> <br> 旅行者 1 号当前距离地球 ${t} 千米，约为 ${n} 个天文单位 🚀</div>` : `<img class='boardsign' src='https://sourcebucket.s3.bitiful.net/badge/F小屋-下班休息啦.svg' title='下班了就该开开心心地玩耍~'><br> <div style="font-size:13px;font-weight:bold">本站居然运行了 ${s} 天 ${r} 小时 ${l} 分 ${b} 秒 <i id="heartbeat" class='fas fa-heartbeat'></i> <br> 旅行者 1 号当前距离地球 ${t} 千米，约为 ${n} 个天文单位 🚀</div>`,
    document.getElementById("workboard") && (document.getElementById("workboard").innerHTML = u)
}
function startFps() {
      ...
      , a = function() {
        ...
        s > 1e3 + n) {
            if ((r = Math.round(1e3 * t / (s - n))) <= 5)
                ...
                i = '<span style="color:red">电竞级帧率😖</span>';
            else if (r <= 25)
                i = '<span style="color:orange">有点难受😨</span>';
            else if (r < 35)
                i = '<span style="color:#9338e6">不太流畅🙄</span>';
            else if (r <= 45)
                i = '<span style="color:#08b7e4">还不错哦😁</span>';
            else
                i = '<span style="color:#39c5bb">十分流畅😂</span>';
...
null == localStorage.getItem("bgFilterVal") && localStorage.setItem("bgFilterVal", "blur(0px) saturate(115%) contrast(105%)");
